...
PROJECT_ROOT = Path(r"C:\Users\bruss\Documents\Codex\2026-04-29\files-mentioned-by-the-user-az")
ROOT = PROJECT_ROOT / "www"
CERT = PROJECT_ROOT / "certs" / "az900-local-server.pem"
KEY = PROJECT_ROOT / "certs" / "az900-local-server-key.pem"
HOST = "0.0.0.0"
PORT = 4443
